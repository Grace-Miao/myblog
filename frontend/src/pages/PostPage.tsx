...
export default function PostPage() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_160px] gap-10">
      <article className="min-w-0">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-6">
            评论{comments.length > 0 && <span className="text-gray-400 font-normal text-base"> · {comments.length}</span>}
          </h2>

          {comments.length === 0 && <p className="text-gray-400 text-sm mb-6">还没有评论，来说第一句吧。</p>}
